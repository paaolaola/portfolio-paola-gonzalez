        ...
        <>
            <header className="box-perfil">
                <div className="mui-links">
                    ...
                    <a href="https://drive.google.com/file/d/1RuSYo_7Y706tQUmZD8738CqBfsjqylXB/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
                    ...
                    <div>
                        <section ref={aboutRef} className="box-about">
                            ...
                            <div className="btn-links">
                                ...
                                <a
                                    href="https://drive.google.com/file/d/1RuSYo_7Y706tQUmZD8738CqBfsjqylXB/view?usp=drive_link"
                                    target="_blank"
