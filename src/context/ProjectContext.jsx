    ...
    const proyectos = [
        {
            ...
            info: 'Techsite es un sitio web hecho con Wordpress, basado en tecnología y con la idea de ofrecer servicios, asesoramientos, talleres y tienda online. Se usaron pluggins como Elementor para diseñar la web, WP Super caché para optimizar la velocidad de carga, entre otros.',
            skills: {
                skill1: 'WordPress',
                skill2: 'Elementor',
