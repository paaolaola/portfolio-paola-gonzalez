...
const StudyProvider = ({ children }) => {
    ...
    const studies = [
        {
            id: 0,
            name: 'SEO y SEM: Estrategias de posicionamiento en Google',
            place: 'Domestika (Mar - Abr 2025)',
            info: 'Curso impartido por Juan González Villa que explica cómo aprovechar al máximo el buscador de Google  para obtener los mejores resultados para tu proyecto o web tanto a nivel de pago como con resultados orgánicos.',
            state: 'seo',
        },
        {
            id: 1,
